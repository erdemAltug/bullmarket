...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `${human}? ${price} TL (${change}) — BullMarket`;
  const description = `${base}/${quote} canlı döviz kuru ${price} TL. Anlık TCMB verisi, dönüştürücü ve değişim oranı BullMarket'te.`;
    ...
    <AssetSeoShell
      ...
      faqs={[
        ...
        },
        {
          ...
          answer:
            'BullMarket döviz kurlarını TCMB verilerine dayalı olarak günceller.',
        },
        {
    ...
    >
      ...
      <section className="rounded-2xl border border-zinc-800/80 bg-zinc-900/40 p-5 text-sm leading-relaxed text-zinc-400">
        ...
        <p>
          ...
          sayfada. Dolar, euro ve diğer pariteler BullMarket FX bölümünden
          takip edilebilir.
        </p>
      </section>
    </AssetSeoShell>
